...
wget -q -O /tmp/changeworkerconfig/change_worker_config.py https://raw.githubusercontent.com/xiopeter3345/useful_script/master/StormWorkerConfig/change_worker_config.py
